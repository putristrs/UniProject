          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="<?=site_url('admin/ubahpass')?>" class="btn btn-default btn-flat">Ubah Profile</a>
                </div>
        ...
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="<?php echo base_url().'admin/ubahpass';?>" method="post">
                 <input type="hidden" class="form-control" value="<?=$tb_admin['0']->id;?>" name="id" id="id">
                  <div class="card-body">
