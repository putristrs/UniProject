...
<head>
  ...
  <title>Admin | Data Rekapitulasi</title>
    ...
    <section class="content">
       <div class="box">
            <div class="box-header">
               <center><h2>Rekapitulasi Peserta Ekstrakurikuler SMP Negeri 1 Banyubiru</h2></center>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                  <tr>
                     ...
                     <td style="font-size: 25px;">Tanggal: <?php echo date('d-m-Y') ?></td>
                  </tr>
                <tr>
                  <th>Nomor</th>
               ...
               <?php } ?>
                ...
                <td></td>
                <td>Jumlah Total</td>
                 <td id="inner"><?php echo $total_eks;?></td>
              </table>
               <a href="<?php echo base_url().'admin/createrekap?>'; ?>" class="btn btn-default btn-sm">
...
<script type="text/javascript">
  ...
  var chart = new Chart(ctx, {
    ...
    data: {
        labels: [
          <?php
            if (count($tb_ekstrakulikuler)>0) {
              foreach ($tb_ekstrakulikuler as $data) {
                echo "'" .$data->nama_ekstrakulikuler ."',";
              }
            }
          ?>
        ],
        datasets: [{
            label: 'Statistik Ekstrakulikuler',
