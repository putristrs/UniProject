          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="#" class="btn btn-default btn-flat">Ubah Profile</a>
                </div>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
         <!--  <a href="#">
          ...
          <li><a href="<?=site_url('admin/view_pendaftar')?>"><i class="fa fa-circle-o"></i>Data Pendaftar</a></li>
        ...
        <li>
          <a href="<?=site_url('admin/view_help')?>">
            <i class="fa fa-gears"></i> <span>Help</span>
          </a>
        </li>
      </ul>
    </section>
              ...
              <table id="example1" class="table table-bordered table-striped">
                <thead>
                 <tr>
                    ...
                    <a href="<?php echo base_url(). 'admin/laporan_pendaftar';?>" class="btn btn-default btn-md">
                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      ...
                      <form role="form" action="<?php echo base_url(). 'admin/insert_pendaftar'; ?>" method="POST">
                      <div class="box-body">
                        <div class="form-group">
                          <input type="hidden" class="form-control"  name="id" id="id">
                          <label for="exampleInputEmail1">Nim</label>
                          <input type="number" class="form-control"  name="nim" id="nim" placeholder="Enter Your Nim" required>
                        </div>
                        <div class="form-group">
                          <label for="exampleInputPassword1">Nama</label>
                          <input type="text" class="form-control"  name="nama_siswa" id="nama" placeholder="Enter Your Name" required>
                        </div>
                          <div class="form-group">
                          <label for="exampleInputPassword1">Tanggal</label>
                          <input type="date" class="form-control"  name="tanggal" id="tanggal" placeholder="Enter Your Name" required>
                        </div>
                       <!--  <div class="form-group">
                ...
                <tr>
                  ...
                  <td>
                     <a class="btn btn-success jarak"  style="float:center" data-toggle="modal" data-target="#EditModal<?=$row->id;?>">Edit</a>   
                      ...
                      <a href="<?=site_url('admin/delete_pendaftar/'.$row->id) ?>" onclick="return confirm('Yakin mau di hapus?');" class="btn btn-danger jarak" style="float:center">Delete</a>
                  ...
                  <div class="modal-dialog">
                    ...
                    <div class="modal-content">
                      ...
                      <!-- body modal -->
                      <div class="modal-body">
                      <form role="form" action="<?php echo base_url(). 'admin/update_pendaftar?>'; ?>" method="POST">
                      <div class="box-body">
                        <div class="form-group">
                            <input type="hidden" class="form-control"  name="id" id="id" value="<?php echo $row->id; ?>">
                          <label for="exampleInputEmail1">Nim</label>
                          <input type="number" class="form-control" name="nim" id="nim" value="<?php echo $row->nim ?>">
                        </div>
                        <div class="form-group">
                          <label for="exampleInputPassword1">Nama</label>
                          <input type="text" class="form-control" name="nama_siswa" id="nama" value="<?php echo $row->nama_siswa ?>">
                        </div>
                         <div class="form-group">
                          <label for="exampleInputPassword1">Tanggal</label>
