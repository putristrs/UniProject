  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <!-- PAGE CONTENT BEGINS -->
          <form class="form-horizontal" role="form" action="kontak/prosestambahdaftarkontak.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" name="nopolisi" id="form-field-1" placeholder="No Polisi" class="col-xs-10 col-sm-5" required/>
              </div>
            </div>
