...
$result = mysqli_query($koneksi, "SELECT * FROM daftarkontak WHERE id=$id");
         ...
         <div class="col-xs-12">
           ...
           <div class="row" style="padding: 20px;">
             <div class="col-md-1">
               ...
               <form class="form-horizontal" role="form" action="kontak/proseseditdaftarkontak.php" method="post" enctype="multipart/form-data">
                 ...
                 <div class="form-group">
                   ...
                   <div class="col-sm-9">
                     ...
                     <option value="<?php echo $data['id']; ?>"><?php echo $data['kode_daftarkontak']; ?></option>
                         <?php
                       }
                     }
                      ?>
                 ...
                 <div class="form-group">
                   ...
                   <div class="col-sm-9">
                     <input type="text" name="nopolisi" id="form-field-1" value="<?php echo $nopolisi ?>" placeholder="No Polisi" class="form-control" required/>
                   </div>
                 </div>
