...
$result = mysqli_query($koneksi, "SELECT * FROM pesanterkirim WHERE id=$id");
         ...
         <div class="col-xs-12">
           ...
           <div class="row" style="padding: 20px;">
             <div class="col-md-1">
               ...
               <form class="form-horizontal" role="form" action="kontak/proseseditpesanterkirim.php" method="post" enctype="multipart/form-data">
