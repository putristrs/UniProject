  ...
  <div class="main-content-inner">
    ...
    <div class="page-content">
      ...
      <div class="row">
        <div class="col-xs-12">
          <!-- PAGE CONTENT BEGINS -->
          <form class="form-horizontal" role="form" action="page/prosestambahpesankeluar.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="timestamp" name="tanggaljam" id="form-field-1" placeholder="Tanggal & Jam" class="col-xs-10 col-sm-5" value="<?php date_default_timezone_set('Asia/Jakarta'); echo  date('d/m/Y H:i:s');?>" required />
              </div>
            </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-9">
                <input type="text" name="status" id="form-field-1" placeholder="status" class="col-xs-10 col-sm-5" required/>
              </div>
            </div>
